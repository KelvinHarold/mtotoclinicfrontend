...
const EditMedicalAdvice = () => {
  ...
  const fetchMedicalAdvice = async () => {
    try {
      ...
      setFormData(adviceData);
    } catch (err) {
      setSubmitError('Failed to fetch medical advice details');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.put(`/medical-advice/${id}`, submissionData);
      
      navigate(`/medical-advice/${id}`, { 
        state: { message: 'Medical advice updated successfully!' } 
      });
      ...
      if (err.response?.status === 422) {
        ...
        setSubmitError('Failed to update medical advice. Please try again.');
      }
    } finally {
      setLoading(false);
    }
          ...
          <form onSubmit={handleSubmit}>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      You are updating this medical advice
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-between items-center pt-4 border-t border-gray-200">
              <div className="text-sm text-gray-500">
                Updating medical advice record #{id}
              </div>
...
export default EditMedicalAdvice;