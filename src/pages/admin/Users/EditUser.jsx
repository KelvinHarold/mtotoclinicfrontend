...
const EditUser = () => {
  ...
  useEffect(() => {
    fetchUser();
    fetchRoles(); // 🔥 SASA TUNAFETCH ROLES KUTOKA SPATIE
  }, [id]);
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setFormData({
          ...
          role: user.roles[0]?.name || '', // 🔥 TUNAONGEZA ROLE KUTOKA SPATIE
          password: '',
          password_confirmation: ''
        });
      }
  ...
  // 🔥 FUNCTION MPYA YA KUFETCH ROLES KUTOKA SPATIE
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                required
                disabled={fetchingRoles} // 🔥 DISABLE WAKATI INAFETCH
              >
                <option value="">{fetchingRoles ? 'Loading roles...' : 'Select Role'}</option>
                {/* 🔥 SASA TUNAMAP ROLES KUTOKA SPATIE */}
                {roles.map((role) => (
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button
              type="submit"
              disabled={loading || fetchingRoles} // 🔥 DISABLE WAKATI INAFETCH ROLES
