...
const CreateVaccination = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post('/vaccinations', submissionData);
      
      // Success - redirect to list page
      navigate('/vaccinations', { 
        state: { message: 'Vaccination record created successfully!' } 
      });
      ...
      if (err.response?.status === 422) {
        ...
        setSubmitError('Failed to create vaccination record. Please try again.');
      }
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Record a new vaccination for a patient</p>
      </div>
          ...
          <form onSubmit={handleSubmit}>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      You are recording this vaccination
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-between items-center pt-4 border-t border-gray-200">
              <div className="text-sm text-gray-500">
                Creating new vaccination record
              </div>
