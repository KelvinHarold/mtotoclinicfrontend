...
const EditBreastfeedingWoman = () => {
  ...
  const handleSubmit = async (formData) => {
    try {
      setLoading(true);
      await axios.put(`/breastfeeding-women/${id}`, formData);
    ...
    <div className="container mx-auto px-4 py-6">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow border p-6">
          <h1 className="text-2xl font-bold text-gray-800 mb-6">Edit Breastfeeding Woman Record</h1>
          <BreastfeedingWomanForm record={record} onSubmit={handleSubmit} loading={loading} />
        </div>
      </div>
    </div>
  );
...
export default EditBreastfeedingWoman;